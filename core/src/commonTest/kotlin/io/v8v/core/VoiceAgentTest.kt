...
class VoiceAgentTest {
    ...
    @Test
    fun final_result_triggers_intent_resolution() = runTest {
    ...
    @Test
    fun unmatched_text_emitted_to_unhandled_flow() = runTest {
        val engine = FakeEngine()
        val config = VoiceAgentConfig(
            language = "en",
            continuous = false,
    ...
    @Test
    fun silence_timeout_promotes_partial_to_final() = runTest {
        val engine = FakeEngine()
        val config = VoiceAgentConfig(
            language = "en",
            continuous = false,
    ...
    @Test
    fun silence_timeout_resets_on_new_partial() = runTest {
        val engine = FakeEngine()
        val config = VoiceAgentConfig(
            language = "en",
            continuous = false,
    ...
    @Test
    fun continuous_mode_restarts_after_final() = runTest {
        val engine = FakeEngine()
        val config = VoiceAgentConfig(
            language = "en",
            continuous = true,
    ...
    @Test
    fun update_config_changes_language() = runTest {
        val engine = FakeEngine()
    ...
    @Test
    fun stop_cancels_silence_promotion() = runTest {
        val engine = FakeEngine()
        val config = VoiceAgentConfig(
            language = "en",
            continuous = false,
    ...
    @Test
    fun benign_errors_are_filtered() = runTest {
        val engine = FakeEngine()
        val config = VoiceAgentConfig(
            language = "en",
            continuous = true,
